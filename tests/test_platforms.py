...
class TestIOSPlatform:
    ...
    def test_supported_languages(self):
        """Test that iOS returns supported languages."""
        platform = IOSPlatform()
        languages = platform.supported_languages
...
class TestPlatformRegistry:
    ...
    def test_get_platform_case_insensitive(self):
        ...
        platform1 = get_platform("iOS")
        platform2 = get_platform("IOS")
        platform3 = get_platform("ios")
